...
/* the pattern definitions come from: http://www.eclipse.org/aspectj/doc/released/progguide/semantics-pointcuts.html#pattern-summary  */
  ...
  final public PositionString QuotesAndAnyIdPattern() throws ParseException {
  PositionString id;
  String text;
  int line, column;
    switch (jj_nt.kind) {
    ...
    line = token.beginLine;
    column = token.beginColumn;
    {if (true) return new PositionString(line, column, text);}
    throw new Error("Missing return statement in function");
  }
