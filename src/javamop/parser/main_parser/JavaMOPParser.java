/* Generated By:JavaCC: Do not edit this line. JavaMOPParser.java */
 ...
 */
public final class JavaMOPParser implements JavaMOPParserConstants {

    private static JavaMOPParser parser;

    public static MOPSpecFileExt parse(InputStream in, String encoding) throws ParseException {
        if (parser == null) {
            parser = new JavaMOPParser(in, encoding);
        } else {
            parser.ReInit(in);
        }
        return parser.MOPSpecFile();
    }

    public static MOPSpecFileExt parse(InputStream in) throws ParseException {
        return parse(in, null);
    }

    public static MOPSpecFileExt parse(File file, String encoding) throws ParseException {
        try {
    ...
    public static MOPSpecFileExt parse(File file) throws ParseException {
    ...
    private String getFormula() throws ParseException {
...
/* operators used in different logics, may need to be extended when new logics come*/

/*************************************************
 * THE JAVAMOP SPECIFICATION GRAMMAR STARTS HERE *
 *************************************************/
  final public MOPSpecFileExt MOPSpecFile() throws ParseException {
        PackageDeclaration packageName = null;
        List<ImportDeclaration> imports = new ArrayList<ImportDeclaration>();
        ImportDeclaration im = null;
        List<JavaMOPSpecExt> specList = new ArrayList<JavaMOPSpecExt>();
        JavaMOPSpecExt spec = null;
        int line = -1;
        int column = -1;
    if (jj_2_1(2147483647)) {
      packageName = PackageDeclaration();
                                                                              line = packageName.getBeginLine(); column = packageName.getBeginColumn();
    } else {
      ;
    }
    label_1:
    while (true) {
      ...
      im = ImportDeclaration();
                                     if(line==-1){line = im.getBeginLine(); column = im.getBeginColumn();} imports.add(im);
    }
    label_2:
    while (true) {
    ...
    default:
      ...
      throw new ParseException();
         ...
         {if (true) return new MOPSpecFileExt(line, column, packageName, imports, specList);}
  ...
  final public JavaMOPSpecExt JavaMOPSpec(PackageDeclaration packageName) throws ParseException {
        ...
        //MethodPattern inMethod = null;
        String inMethod = null;
        List<BodyDeclaration> declarations = null;
        List<EventDefinitionExt> events = new ArrayList<EventDefinitionExt>();
        EventDefinitionExt event = null;
        List<PropertyAndHandlersExt> props = new ArrayList<PropertyAndHandlersExt>();
        PropertyAndHandlersExt prop = null;
        int line = -1;
        int column = -1;
    ...
    default:
      ...
      throw new ParseException();
                                         ...
                                         if(line==-1){line = token.beginLine; column = token.beginColumn;} name = token.image;
    switch (jj_nt.kind) {
    case LPAREN:
      parameters = MOPParameters();
      break;
    default:
      jj_la1[5] = jj_gen;
      ;
    ...
    case INCLUDES:
      ...
      extendedSpecList = MOPExtendedSpec();
      break;
    default:
      jj_la1[7] = jj_gen;
      ;
    ...
    declarations = ClassOrInterfaceBody(false);
    label_3:
    while (true) {
      event = Event();
                           events.add(event);
  ...
  final public int SpecModifier() throws ParseException {
        int modifiers = 0;
    label_5:
    while (true) {
      switch (jj_nt.kind) {
      ...
      case UNSYNC:
        jj_consume_token(UNSYNC);
                           modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.UNSYNC, token);
        break;
      case DECENT:
        jj_consume_token(DECENT);
                          modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.DECENTRL, token);
        break;
      case PERTHREAD:
        jj_consume_token(PERTHREAD);
                      modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.PERTHREAD, token);
        break;
      case SUFFIX:
        jj_consume_token(SUFFIX);
                   modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.SUFFIX, token);
        break;
      case FULLBIND:
        jj_consume_token(FULLBIND);
                         modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.FULLBINDING, token);
        break;
      case AVOID:
        jj_consume_token(AVOID);
                  modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.AVOID, token);
        break;
      case ENFORCE:
        jj_consume_token(ENFORCE);
                    modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.ENFORCE, token);
        break;
      case CONNECTED:
        jj_consume_token(CONNECTED);
                      modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, SpecModifierSet.CONNECTED, token);
        break;
      default:
        jj_la1[11] = jj_gen;
        jj_consume_token(-1);
...
//**************** soha adding here*************/
//List<MOPExtendedSpec> MOPExtendedSpec():
  final public List<ExtendedSpec> MOPExtendedSpec() throws ParseException {
        List<ExtendedSpec> extendedSpecList= new ArrayList<ExtendedSpec>();
        ExtendedSpec S = null;
    S = singleExtendedSpec();
                             extendedSpecList.add(S);
    label_6:
    while (true) {
      switch (jj_nt.kind) {
      case COMMA:
   ...
   {if (true) return extendedSpecList;}
    throw new Error("Missing return statement in function");
  }

  final public ExtendedSpec singleExtendedSpec() throws ParseException {
 ...
 int line, column;
    ...
    default:
      ...
      throw new ParseException();
                                  ...
                                  specName = token.image; line = token.beginLine; column = token.beginColumn;
    switch (jj_nt.kind) {
    case LPAREN:
      ...
      default:
        ...
        throw new ParseException();
                                        ...
                                        isParametric = true; parameterList.add(token.image);
      label_7:
      while (true) {
        switch (jj_nt.kind) {
        case COMMA:
   ...
   {if (true) return new ExtendedSpec(line, column, specName, isParametric, parameterList);}
    throw new Error("Missing return statement in function");
  }

//************ soha ends addition here*************/
  final public List<MOPParameter> MOPParameters() throws ParseException {
  ...
  final public List<MOPParameter> AdviceParameters() throws ParseException {
        List<MOPParameter> parameters = new ArrayList<MOPParameter>();
        MOPParameter p = null;
    jj_consume_token(LPAREN);
    switch (jj_nt.kind) {
  ...
  final public MOPParameter MOPParameter() throws ParseException {
        TypePattern type;
        String name;
        int line;
        int column;
    type = SimpleTypePattern();
                                    line = type.getBeginLine(); column = type.getBeginColumn();
    switch (jj_nt.kind) {
    case IDENTIFIER:
      jj_consume_token(IDENTIFIER);
      break;
    ...
    default:
      ...
      throw new ParseException();
                                                                                                                                  ...
                                                                                                                                  name = token.image;
          {if (true) return new MOPParameter(line, column, type, name);}
    throw new Error("Missing return statement in function");
  }

  final public MOPParameter AdviceParameter() throws ParseException {
        TypePattern type;
        String name;
        int line;
        int column;
  ...
  final public EventDefinitionExt Event() throws ParseException {
    ...
    case CREATION:
      ...
      case EVENT:
        ...
        break;
      case BLOCKINGEVENT:
        jj_consume_token(BLOCKINGEVENT);
                          line = token.beginLine; column = token.beginColumn; blockingEvent = true;
        break;
      default:
        jj_la1[32] = jj_gen;
        jj_consume_token(-1);
    ...
    default:
      ...
      throw new ParseException();
          ...
          {if (true) return new EventDefinitionExt(line, column, id, rettype, pos, parameters, pointCut, block, hasReturning, retVal, hasThrowing, throwVal, startEvent, abstractEvent, blockingEvent);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public BaseTypePattern SimpleTypePattern() throws ParseException {
        String id;
        int line, column;
    switch (jj_nt.kind) {
    case IDENTIFIER:
  ...
  final public BaseTypePattern TypePattern() throws ParseException {
        String id;
        int line, column;
    switch (jj_nt.kind) {
    case IDENTIFIER:
  ...
  final public PropertyAndHandlersExt PropertyAndHandlers(int propId) throws ParseException {
        ...
        String id;
        HashMap<String, BlockStmt> handlers = new HashMap<String, BlockStmt>();
        int line, column;
        HandlerExt h = null;
    ...
    while (true) {
      ...
      default:
        ...
        throw new ParseException();
                                    ...
                                    id = token.image; line = token.beginLine; column = token.beginColumn; propertyReference = null; specReference = null;
      switch (jj_nt.kind) {
      case AT:
      case DOT:
        switch (jj_nt.kind) {
        case AT:
          ...
          default:
            ...
            throw new ParseException();
                                          ...
                                          propertyReference = id; id = token.image;
          break;
        case DOT:
          jj_consume_token(DOT);
          switch (jj_nt.kind) {
          ...
          default:
            ...
            throw new ParseException();
                                             ...
                                             specReference = id; propertyReference = token.image;
          jj_consume_token(AT);
          switch (jj_nt.kind) {
          case IDENTIFIER:
            jj_consume_token(IDENTIFIER);
      ...
      h = new HandlerExt(line, column, id, handler, specReference, propertyReference);
      handlerList.add(h);
      if (jj_2_2(2)) {
        ;
      } else {
...
//  if (handlers.size() == 0)
//    throw new ParseException(token, "At least one handler is expected");
//  if(handlers.size() == 0) handlers = null;
    {if (true) return new PropertyAndHandlersExt(line, column, prop, handlers, handlerList);}
    throw new Error("Missing return statement in function");
  }
    ...
    if (jj_2_3(3)) {
      ...
      default:
        ...
        throw new ParseException();
                                    ...
                                    line = token.beginLine; column = token.beginColumn; propertyName = token.image;
      jj_consume_token(COLON);
    } else {
      switch (jj_nt.kind) {
      case GET:
      ...
      default:
        ...
        throw new ParseException();
         ...
         f = getFormula();
          {if (true) return new FormulaExt(line, column, logicId, f, propertyName);}
    throw new Error("Missing return statement in function");
  }

/***********************************************
 * THE JAVAMOP SPECIFICATION GRAMMAR ENDS HERE *
 ***********************************************/
  ...
  final public Modifier Modifiers() throws ParseException {
   ...
   AnnotationExpr ann;
    ...
    while (true) {
      ...
      case PUBLIC:
        jj_consume_token(PUBLIC);
              modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, javamop.parser.ast.body.ModifierSet.PUBLIC, token);
        break;
      case STATIC:
        jj_consume_token(STATIC);
              modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, javamop.parser.ast.body.ModifierSet.STATIC, token);
        break;
      case PROTECTED:
        jj_consume_token(PROTECTED);
                 modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, javamop.parser.ast.body.ModifierSet.PROTECTED, token);
        break;
      case PRIVATE:
        jj_consume_token(PRIVATE);
               modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, javamop.parser.ast.body.ModifierSet.PRIVATE, token);
        break;
      case FINAL:
        jj_consume_token(FINAL);
             modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, javamop.parser.ast.body.ModifierSet.FINAL, token);
        break;
      case ABSTRACT:
        jj_consume_token(ABSTRACT);
                modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, javamop.parser.ast.body.ModifierSet.ABSTRACT, token);
        break;
      case SYNCHRONIZED:
        jj_consume_token(SYNCHRONIZED);
                    modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, javamop.parser.ast.body.ModifierSet.SYNCHRONIZED, token);
        break;
      case NATIVE:
        jj_consume_token(NATIVE);
              modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, javamop.parser.ast.body.ModifierSet.NATIVE, token);
        break;
      case TRANSIENT:
        jj_consume_token(TRANSIENT);
                 modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, javamop.parser.ast.body.ModifierSet.TRANSIENT, token);
        break;
      case VOLATILE:
        jj_consume_token(VOLATILE);
                modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, javamop.parser.ast.body.ModifierSet.VOLATILE, token);
        break;
      case STRICTFP:
        jj_consume_token(STRICTFP);
                modifiers = javamop.parser.ast.body.ModifierSet.addModifier(modifiers, javamop.parser.ast.body.ModifierSet.STRICTFP, token);
        break;
      case AT:
        ann = Annotation();
                        annotations = add(annotations, ann);
...
/* Annotation Types. */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x1000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2094000,0x0,0x0,0x0,0x2094000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2094000,0x0,0x0,0x0,0x0,0x0,0x0,0x1000,0x0,0x0,0x0,0x0,0x0,0x0,0x2094000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x48101000,0x1,0x0,0x0,0x0,0x40001000,0x8100000,0x48101000,0x100000,0x0,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4a195000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x
0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x8000,0x0,0x0,0x8000,0x40000,0x0,0x4,0x0,0x4008000,0x0,0x0,0x2000000,0x8000,0x8000,0x2000000,0x8000,0x40000,0x2000000,0x8000,0x2000000,0x8000,0x8000,0x8000,0x8000,0x8000,0x40000,0x40000,0x0,0x40000,0x0,0x0,0x0,0x8000,0x8000,0x40000,0x40000,0x0,0x40000,0x0,0x1100000,0x0,0x0,0x8000,0x8000000,0x8000,0x400000,0x0,0x8000,0x8000000,0x8000,0x400000,0x0,0x8000,0x8000,0x8000,0x8000,0x8000,0xc000000,0xc000000,0x8000,0x8000,0x8000,0x8000,0x0,0x5000000,0x0,0x4000000,0x0,0x8000000,0x4000000,0x4000000,0x5000000,0x0,0x8000,0x20000000,0x0,0x0,0x2000000,0x2000000,0x8000,0x0,0x4008000,0x2000000,0x25108000,0x1000000,0x4000000,0x8000,0x40000,0x100000,0x2000000,0x8000,0x0,0x0,0x4000000,0x20008000,0x25008000,0x2000000,0x10000000,0x8000,0x400000,0xc014e118,0xc014e118,0x2000000,0x20000000,0x8000,0x400000,0x0,0x1100000,0x2000000,0x4008000,0x0,0x20000000,0x8000,0x0,0x20000000,0x20000000,0x2004e118,0x514e118,0x0,0x0,0x8000,0x8000,0x8000,0x2000000,0x8000,0x0,0x0,0x0,0x8000,0x8000,0x2000000,0x10000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0xc004e118,0xc0000000,0xc0000000,0x4e118,0x40000,0x0,0x20000000,0x8000,0x40000,0x8000,0x40000,0x46118,0x8000,0x8000000,0x20000000,0x8000,0x40000,0x0,0x8400000,0x6118,0x0,0xc004e118,0x2000000,0x20000000,0x440000,0x20008000,0x400000,0x400000,0x114e118,0x0,0x8000,0x114e118,0x2000000,0x10000000,0x10000000,0x4e118,0x0,0x0,0x0,0xc404e118,0xc004e118,0xc004e118,0xc504e118,0xc004e118,0x2000000,0x8000,0x8000,0x8000,0x8000,0xc004e118,0x0,0x0,0x0,0x4000000,0x8000,0x2000000,0x8000,0xc414e118,0xc414e118,0x2000000,0x8000,0x5008000,0x4008000,0x5008000,0x8000,0x0,};
   }
   private static void jj_la1_init_4() {
      jj_la1_4 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x400,0x0,0x0,0x0,0x0,0x400,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf00,0xf00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,0x0,0x0,0x0,0x0,0x0,0x0,0x300,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x3ff80000,0x1,0x40,0x80,0x8000,0x10000,0x4000,0x24,0x24,0x0,0x18,0x18,0x40000,0xc00,0xc00,0x23000,0x23000,0xc00,0xf00,0x0,0x0,0x0,0x0,0x300,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf00,0x0,0x0,0x0,0x0,0x0,0x0,0x300,0x2,0x0,0x300,0x0,0x3ff80300,0x3ff80300,0x300,0x0,0x0,0x0,0xf00,0xf00,0xf00,0xf00,0xf00,0x0,0x0,0x0,0x0,0x0,0xf00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf00,0xf00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
   private static void jj_la1_init_5() {
      jj_la1_5 = new int[] {0x0,0x0,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
  ...
  public JavaMOPParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public JavaMOPParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new JavaMOPParserTokenManager(jj_input_stream);
    token = new Token();
  ...
  /** Constructor. */
  public JavaMOPParser(java.io.Reader stream) {
  ...
  public JavaMOPParser(JavaMOPParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    token.next = jj_nt = token_source.getNextToken();
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(JavaMOPParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    token.next = jj_nt = token_source.getNextToken();
    jj_gen = 0;
