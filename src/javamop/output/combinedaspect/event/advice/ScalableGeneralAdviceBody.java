...
public class ScalableGeneralAdviceBody extends GeneralAdviceBody {
	...
	public ScalableGeneralAdviceBody(JavaMOPSpec mopSpec, EventDefinition event, CombinedAspect combinedAspect) throws MOPException {
	...
	public String toString() {
		...
		ret += "// From here, Assume all TempRef_* are filled\n";
		 ...
		 * 
		 * mainMap is not null unless it has less than one parameter
		 * 
