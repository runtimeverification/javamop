...
public class JavaCodeGenVisitor implements GenericVisitor<String, Object> {
	...
	public String visit(PseudoCode_NotExpr n, Object arg) {
		...
		if(n.getExpr() instanceof PseudoCode_NotExpr){
			PseudoCode_NotExpr sub = (PseudoCode_NotExpr)n.getExpr();
			ret += sub.getExpr().accept(this, arg);
		} else {
	...
	public String visit(PseudoCode_Assignment n, Object arg){
		...
		if(n.getExpr() instanceof PseudoCode_VarExpr){
			PseudoCode_VarExpr value = (PseudoCode_VarExpr)n.getExpr();
			if(value.getType() == n.getVar().getType() && value.getIndex() == n.getVar().getIndex())
				return ret;
		}
