...
public class Configuration {
	...
	public static String getConfigPath() {
		String configPath;
		try {
			Class<?> testClass = Class.forName("logicrepository.Configuration");
			ClassLoader loader = testClass.getClassLoader();
			String testClassPath = loader.getResource("logicrepository/Configuration.class").toString();

			if (testClassPath.endsWith(".jar!/logicrepository/Configuration.class") && testClassPath.startsWith("jar:")) {
				String jarFilePath;
				jarFilePath = testClassPath.substring("jar:file:".length(), testClassPath.length() - "!/logicrepository/Configuration.class".length());
