...
public class Main {
	...
	static public void main(String[] args) {
		...
		try {
			...
			String mainClassPath = loader.getResource("logicrepository/Main.class").toString();
			String logicRepositoryPath;
			if (mainClassPath.endsWith(".jar!/logicrepository/Main.class") && mainClassPath.startsWith("jar:")) {

				logicRepositoryPath = mainClassPath.substring("jar:file:".length(), mainClassPath.length()
						- "logic.repository.jar!/logicrepository/Main.class".length());
				...
				jarFilePath = mainClassPath.substring("jar:file:".length(), mainClassPath.length()
						- "!/logicrepository/Main.class".length());
