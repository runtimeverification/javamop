...
public class MOPMultiTagRefMapOfMap extends MOPBasicRefMapOfMap {
	int taglen = 1;
	...
	public MOPMultiTagRefMapOfMap(int idnum) {
		super(idnum);
	...
	public MOPMultiTagRefMapOfMap(int idnum, int taglen) {
		super(idnum);
