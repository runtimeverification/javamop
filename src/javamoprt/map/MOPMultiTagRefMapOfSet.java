...
public class MOPMultiTagRefMapOfSet extends MOPBasicRefMapOfSet {
	int taglen = 1;
	...
	public MOPMultiTagRefMapOfSet(int idnum) {
		super(idnum);
	...
	public MOPMultiTagRefMapOfSet(int idnum, int taglen) {
		super(idnum);
