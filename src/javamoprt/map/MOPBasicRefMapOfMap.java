...
public class MOPBasicRefMapOfMap extends MOPMapOfMap implements MOPRefMap {
	...
	public MOPBasicRefMapOfMap(int idnum) {
		super(idnum);
	...
	protected void endObject(int idnum) {
		...
		for (int i = data.length - 1; i >= 0; i--) {
			...
			while (entry != null) {
				...
				MOPAbstractMapSolo map = (MOPAbstractMapSolo) entry.value;
