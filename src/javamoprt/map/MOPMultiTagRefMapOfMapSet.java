...
public class MOPMultiTagRefMapOfMapSet extends MOPBasicRefMapOfMapSet {
	int taglen = 1;
	...
	public MOPMultiTagRefMapOfMapSet(int idnum) {
		super(idnum);
	...
	public MOPMultiTagRefMapOfMapSet(int idnum, int taglen) {
		super(idnum);
