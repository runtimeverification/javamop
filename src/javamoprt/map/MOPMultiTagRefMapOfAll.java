...
public class MOPMultiTagRefMapOfAll extends MOPBasicRefMapOfAll {
	int taglen = 1;
	...
	public MOPMultiTagRefMapOfAll(int idnum) {
		super(idnum);
	...
	public MOPMultiTagRefMapOfAll(int idnum, int taglen) {
		super(idnum);
