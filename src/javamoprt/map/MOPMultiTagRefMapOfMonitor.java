...
public class MOPMultiTagRefMapOfMonitor extends MOPBasicRefMapOfMonitor {
	int taglen = 1;
	...
	public MOPMultiTagRefMapOfMonitor(int idnum) {
		super(idnum);
	...
	public MOPMultiTagRefMapOfMonitor(int idnum, int taglen) {
		super(idnum);
