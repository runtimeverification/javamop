...
public class MOPVersionedBooleanArrayStack implements MOPObject{
	public boolean[][] data;
	public int[] version;
	public int curr_index = 0;

	public MOPVersionedBooleanArrayStack() {
		data = new boolean[32][];
		version = new int[32];
	}

	public MOPVersionedBooleanArrayStack(int size) {
	...
	public MOPVersionedBooleanArrayStack fclone() {
		MOPVersionedBooleanArrayStack ret = new MOPVersionedBooleanArrayStack(data.length);
