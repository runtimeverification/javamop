...
public class Specification {
     ...
     *            Words before the name directing behavior of rv-monitor.
     * @param name
     *            The name of the specification.
     * @param languageParameters
     *            Parameters used to parameterize the monitor.
     * @param languageDeclarations
     *            Language-specific declarations used in the monitoring code.
     * @param events
     *            The events to monitor in the code.
     * @param properties
