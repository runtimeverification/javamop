...
public class RVMMultiTagRefMapOfSetMon extends RVMBasicRefMapOfSetMon {
	int taglen = 1;
	...
	public RVMMultiTagRefMapOfSetMon(int idnum) {
		super(idnum);
	...
	public RVMMultiTagRefMapOfSetMon(int idnum, int taglen) {
		super(idnum);
