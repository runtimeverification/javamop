...
public class RVMMultiTagRefMapOfMap extends RVMBasicRefMapOfMap {
	int taglen = 1;
	...
	public RVMMultiTagRefMapOfMap(int idnum) {
		super(idnum);
	...
	public RVMMultiTagRefMapOfMap(int idnum, int taglen) {
		super(idnum);
