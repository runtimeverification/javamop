...
public class RVMMultiTagRefMapOfAll extends RVMBasicRefMapOfAll {
	int taglen = 1;
	...
	public RVMMultiTagRefMapOfAll(int idnum) {
		super(idnum);
	...
	public RVMMultiTagRefMapOfAll(int idnum, int taglen) {
		super(idnum);
