...
public class RVMMultiTagRefMapOfSet extends RVMBasicRefMapOfSet {
	int taglen = 1;
	...
	public RVMMultiTagRefMapOfSet(int idnum) {
		super(idnum);
	...
	public RVMMultiTagRefMapOfSet(int idnum, int taglen) {
		super(idnum);
