...
public class RVMMultiTagRefMapOfMapSet extends RVMBasicRefMapOfMapSet {
	int taglen = 1;
	...
	public RVMMultiTagRefMapOfMapSet(int idnum) {
		super(idnum);
	...
	public RVMMultiTagRefMapOfMapSet(int idnum, int taglen) {
		super(idnum);
